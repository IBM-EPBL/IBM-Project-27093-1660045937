# -*- coding: utf-8 -*-
"""
Created on Thu Nov 17 11:41:20 2022
...
def y_predict():
    ...
    new_row = {'yearOfRegistration':regyear, 'powerPS':powerps, 'kilometer':kms, 'monthOfRegistration':regmonth, 'gearbox':gearbox, 'notRepairedDamage':damage, 'vehicleType':vehicletype}
    print(new_row)
    ...
    labeled = new_df[ ['yearOfRegistraion'
                       ,'powerPS'
                       ,'kilometer'
                       ,'monthOfRegistration'
                      ]
